...
Die oben dargestellten Ergebnisse wurden mit der Applikation \code{top} aufgezeichnet. \code{Top} zeigt eine Echtzeit Ansicht des laufenden Systems durch eine Liste von Tasks die momentan vom Linux Kernel verwaltet werden\cite[:12]{ubuntu_top}.
